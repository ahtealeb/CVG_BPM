...
public class ReBuildParallel {
      ...
      private void createLaneItems(XPath xPath  , Document xmlDocument , ArrayList<cvg.Node> orderedNodes ,  String nameFlag , Integer y , int counter) throws Exception{
                          ...
                          for(int i = 0 ; i < orderedNodes.size() ; i++){
                              ...
                              Element el = null;
                                  if("parallelGateway".equals(node.getNodeName())){
                                     el = xmlDocument.createElement(node.getNodeName());
                                     el.setAttribute("gatewayDirection", "Diverging"); 
                                     ...
                                     el.setAttribute("name", "");
                                      ...
                                      Element boundsEl = xmlDocument.createElement("omgdc:Bounds");
                                      boundsEl.setAttribute("height", "40");
                                      boundsEl.setAttribute("width", "40.0");
                                      if(counter == 0){
                                        boundsEl.setAttribute("x", x.toString());
                                        boundsEl.setAttribute("y", String.valueOf(y+30));
                                      }
                                      
                                       if(counter == 1){
                                        boundsEl.setAttribute("x", "780.0");
                                        boundsEl.setAttribute("y", String.valueOf(y+30));
                                      }
                                      shapeEl.appendChild(boundsEl);
                                ...
                                if("task".equals(node.getNodeName())){
                                     ...
                                     el = xmlDocument.createElement(node.getNodeName());
                                         el.setAttribute("id", node.getNodeId()+nameFlag);
                                        el.setAttribute("name", "Terminate End");
                                        procesSetNode.appendChild(el);
                                        ...
                                        Element termination = xmlDocument.createElement("terminateEventDefinition");
                                        termination.setAttribute("id", "terminate"+node.getNodeId()+nameFlag);
                                        el.appendChild(termination);
      ...
      public void createSequenceFlow( Node sourceNode ,  Node targetNode , String file , int fragmentCounter, Fragment fragment , boolean isFirst , String title){
	        ...
	        try {
		       ...
		       // Element el = gateWayElements.get(fragmentCounter);
                ...
                System.out.println();
                 ...
                 String gateWayExpression = "/definitions/process/"+sourceNode.getNodeName()+"[@id='"+sourceNode.getNodeId()+"']";    
                ...
                String taskExpression = "/definitions/process/"+targetNode.getNodeName()+"[@id='"+targetNode.getNodeId()+"']";    
               ...
               // Element el = xmlDocument.getElementById(gateWayNode.getNodeId());
                ...
                taskElement.appendChild(incomingEl);  
                    ...
                    seq_flow.setAttribute("name", title);
                    seq_flow.setAttribute("sourceRef", sourceNode.getNodeId());
                    seq_flow.setAttribute("targetRef", targetNode.getNodeId());
                    procesSetNode.appendChild(seq_flow);
